...
export const loginGroups = [
    {
        ...
        options: [
            ...
            { href: "/ventas-y-facturacion", label: "Ventas y Facturación", icon: ShoppingCart, description: "Punto de Venta (TPV) y análisis comercial." },
            { href: "/gestion-rrhh", label: "Gestión de RR.HH.", icon: Briefcase, description: "Administración de personal, nóminas y talento." },
